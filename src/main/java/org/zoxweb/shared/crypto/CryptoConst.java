...
public final class CryptoConst {
    ...
    public enum HashType
        ...
        private static volatile SetStringContainer ssc = null;


        private final String name;
        public final String[] VARIANCES;

        HashType(String name, String... variances) {
            this.name = name;
            ...
            if (ret == null) {
                for (HashType ht : values()) {
                    if (ht.VARIANCES != null) {
                        for (String s : ht.VARIANCES) {
                            if (s.equalsIgnoreCase(mdName)) {
                                return ht;
                            }
                        }
                    }
        ...
        public static String validate(String mdName) {
            if (ssc == null) {
                synchronized (HashType.class) {
                    if (ssc == null) {
                        ssc = new SetStringContainer(Const.StringType.LOWER);
                        for (HashType ht : values()) {
                            ssc.add(ht.getName());
                            if (ht.VARIANCES != null) {
                                for (String s : ht.VARIANCES) {
