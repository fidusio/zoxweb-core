...
public class EncryptedData
    ...
    /**
     * The getGUID() and setGUID() must hold the same value of the resource GUID it is a one to one mapping
    ...
    protected enum Param
        ...
        EXPIRY_DATE(NVConfigManager.createNVConfig("expiry_date", "Expiry date if set", "ExpiryDate", false, true, String.class)),
        ...
        HMAC_ALL(NVConfigManager.createNVConfig("hmac_all", "If true hmac will applied to GUID", "HMACAll", false, true, Boolean.class)),
    ...
    public void setExpiryDate(String expiryDate) {
        setValue(Param.EXPIRY_DATE, expiryDate);
    }
