...
public class CRUDNVEntityListDAO
    ...
    public static final NVConfigEntity NVC_CRUD_NVENTITY_LIST_DAO = new NVConfigEntityPortable("crud_nventity_list_dao", null, "CRUDNVEntityListDAO", true, false, false, false, CRUDNVEntityListDAO.class, SUS.extractNVConfigs(Param.values()), null, false, SetNameDAO.NVC_NAME_DAO);
