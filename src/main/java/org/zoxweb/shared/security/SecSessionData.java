...
public class SecSessionData
    ...
    public synchronized SecSessionData addPermissions(String... permissionsToAdd) {
        List<String> permissions = lookupValue(Param.PERMISSIONS.getName());
    ...
    public synchronized SecSessionData addRoles(String... rolesToAdd) {
    ...
    public String sessionID() {
        return getProperties().lookupValue(ExtraParam.SESSION_ID);
    }
