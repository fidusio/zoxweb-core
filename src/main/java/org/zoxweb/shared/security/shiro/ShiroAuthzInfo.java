...
public class ShiroAuthzInfo
    ...
    public static final NVConfigEntity NVC_SHIRO_AUTHZ_INFO = new NVConfigEntityPortable("shiro_authz_info", "Shiro authorization info", "ShiroAuthzInfo",
    ...
    public String toCanonicalID() {
        return SUS.toCanonicalID(CAN_ID_SEP, getDomainID(), getAppID(), getSubjectGUID(),
