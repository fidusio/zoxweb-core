...
public class AnnotationScanTest {
    ...
    public void annotationScan() {
        ...
        Method[] methods = result.findMethodsByType(EndPointProp.class);
        for (Method method : methods) {
            assert (ReflectionUtil.isMethodAnnotatedAs(method, EndPointProp.class));
            System.out.println(method.getName() + " has " + ReflectionUtil.getAnnotationFromMethod(method, EndPointProp.class));
        }
